...
def plot_speed_trace(result: LapResult, out_base: Path) -> None:
...
def plot_yaw_moment_vs_lateral_acc(result: LapResult, out_base: Path) -> None:
...
def plot_gg_diagram(result: LapResult, out_base: Path) -> None:
...
def plot_tire_load_distribution(result: LapResult, out_base: Path) -> None:
...
def plot_power_trace(result: LapResult, out_base: Path) -> None:
...
def export_standard_plots(result: LapResult, output_dir: str | Path) -> None:
