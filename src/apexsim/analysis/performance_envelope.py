...
class PerformanceEnvelopePhysics:
    ...
    def validate(self) -> None:
        ...
        Raises:
            apexsim.utils.exceptions.ConfigurationError: If speed bounds are
...
class PerformanceEnvelopeNumerics:
    ...
    def validate(self) -> None:
        ...
        Raises:
            apexsim.utils.exceptions.ConfigurationError: If sample counts or
...
class PerformanceEnvelopeRuntime:
    ...
    def validate(self) -> None:
        ...
        Raises:
            apexsim.utils.exceptions.ConfigurationError: If backend selection
...
class PerformanceEnvelopeConfig:
    ...
    def validate(self) -> None:
        ...
        Raises:
            apexsim.utils.exceptions.ConfigurationError: If any physical,
...
def build_performance_envelope_config(
    ...
    Raises:
        apexsim.utils.exceptions.ConfigurationError: If assembled settings are
            inconsistent.
    """
...
def _validate_torch_model_api(model: VehicleModel) -> None:
    ...
    Raises:
        apexsim.utils.exceptions.ConfigurationError: If required torch API
...
def _solve_performance_envelope_torch_impl(
    ...
    Raises:
        apexsim.utils.exceptions.ConfigurationError: If torch model methods
...
def compute_performance_envelope(
    ...
    *,
    ...
    Raises:
        apexsim.utils.exceptions.ConfigurationError: If configuration is
