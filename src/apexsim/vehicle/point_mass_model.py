...
from apexsim.vehicle._point_mass_backends import (
...
if TYPE_CHECKING:
    ...
    from apexsim.vehicle.single_track_model import SingleTrackNumerics, SingleTrackPhysics
...
class PointMassPhysics:
    ...
    def validate(self) -> None:
        ...
        Raises:
            apexsim.utils.exceptions.ConfigurationError: If limits or
...
class PointMassModel(
    ...
    def _validate_backend(self) -> None:
        ...
        Raises:
            apexsim.utils.exceptions.ConfigurationError: If point-mass
...
def calibrate_point_mass_friction_to_single_track(
    ...
    Args:
        ...
        single_track_physics: Optional single_track-physics settings for calibration.
            Defaults to :class:`apexsim.vehicle.SingleTrackPhysics`.
        single_track_numerics: Optional single_track numerical settings for calibration.
            Defaults to :class:`apexsim.vehicle.SingleTrackNumerics`.
    ...
    Raises:
        apexsim.utils.exceptions.ConfigurationError: If provided speed
